 ...
 * @author quang
 */
@WebServlet(name = "ApartmentLivingHistory", urlPatterns = {"/apartment-living-history"})
public class ApartmentLivingHistory extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ApartmentLivingHistory</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ApartmentLivingHistory at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
