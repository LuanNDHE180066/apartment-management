 ...
 * @author thanh
 */
@WebServlet(name="UpdateResidentService", urlPatterns={"/update-service-resident"})
public class UpdateResidentService extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet UpdateResidentService</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet UpdateResidentService at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
