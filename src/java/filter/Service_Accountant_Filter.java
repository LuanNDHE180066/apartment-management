...
public class Service_Accountant_Filter implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        if (debug) {
            log("Service_Staff_Filter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("Service_Staff_Filter:DoAfterProcessing");
        }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("Service_Staff_Filter()");
        }
        StringBuffer sb = new StringBuffer("Service_Staff_Filter(");
