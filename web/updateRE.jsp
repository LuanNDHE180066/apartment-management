                        ...
                        <div class="container-fluid">
                            <div class="form-container">
                                ...
                                <form action="updateRE" method="post">
                                    ...
                                    <div class="form-group">
                                        <div class="add-account-button" onclick="toggleAccountFields()">
                                            <i class="fa fa-plus"></i> Create New Account
                                        </div>
                                        <div id="account-fields" class="hidden">
                                            <div class="form-group">
                                                <label for="username">Username</label>
                                                <input type="text" id="username" name="username" placeholder="Enter username" <c:if test="${resident.username !=null}">readonly</c:if> />
                                                    <span id="username-error" class="error-message"></span>
                                                </div>
                                                <div class="form-group">
                                                    <label for="email">Email</label>
                                                    <input type="email" id="email" name="email" placeholder="Enter email" value="${resident.email}" <c:if test="${resident.email !=null}">readonly</c:if>/>
