...
<body>
                            ...
                            <form action="update-apartment" method="post">
                                ...
                                <div class="form-row">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="livingResident" value="" name="livingResident" placeholder="Select Resident..." readonly class="clickable" onclick="openResidentModal()">
    ...
    <script>
        // Kh?i t?o danh sách c? dân ?ã ch?n t? server
        ...
        function updateSelectedResidentsDisplay() {
            ...
            display.innerHTML = ''; // Xóa n?i dung c?
