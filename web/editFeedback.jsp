                            ...
                            <form action="update-feed-back" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="typeOfRequest" name="typeOfRequest" class="form-control" required>
                                        ...
                                        <c:forEach items="${requestScope.listOfTypeRequest}" var="tr">
                                            <option value="${tr.id}" <c:if test="${feedback.requestType.name != null && feedback.requestType.name == tr.id}">
                                                    selected
                                                </c:if>>${tr.name}</option>
                                        </c:forEach>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <label><input type="radio" name="rate" value="2" <c:if test="${feedback.rate==1}">checked="" </c:if>> Bad</label>
                                        <label><input type="radio" name="rate" value="3"<c:if test="${feedback.rate==1}">checked="" </c:if>> Neutral</label>
                                        <label><input type="radio" name="rate" value="4"<c:if test="${feedback.rate==1}">checked="" </c:if>> Good</label>
                                        <label><input type="radio" name="rate" value="5"<c:if test="${feedback.rate==1}">checked="" </c:if>> Excellent</label>
                                        </div>
                                    </div>
